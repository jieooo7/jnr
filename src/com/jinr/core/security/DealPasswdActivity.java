/*
 * DealPasswdActivity.java
 * @author Andrew Lee
 * 2014-10-23 上午10:29:55
 */
 ...
 * 2014-10-23 上午10:29:55
 */
public class DealPasswdActivity extends Base2Activity implements
OnClickListener{
	...
	private EditText old_passwd_et;//登录密码
	private EditText new_passwd_et;//交易密码
	private EditText submit_new_passwd_et;//新交易密码
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.change_deal_passwd);
	...
	protected void findViewById() {
		...
		submit=(Button)findViewById(R.id.change_deal_submit);
		
		old_passwd_et=(EditText)findViewById(R.id.change_deal_et1);
		new_passwd_et=(EditText)findViewById(R.id.change_deal_et2);
		submit_new_passwd_et=(EditText)findViewById(R.id.change_deal_et3);
	}
	...
	protected void submit() {
		...
		if("".equals(old_passwd)){
			...
			if("".equals(new_passwd)||new_passwd.length()<6){
				ToastUtil.show(this,
						getResources().getString(R.string.please_input)+getResources().getString(R.string.new_deal_passwd));
			}else{
				if(("".equals(submit_new_passwd))){
					ToastUtil.show(this,
							getResources().getString(R.string.please_input)+getResources().getString(R.string.submit_deal_passwd));
				}else{
...
//		params.put("checksms", code);
		params.put("user_pwd", new_passwd);
		params.put("user_rpwd", submit_passwd);
		params.put("user_id", user_id);
		
		MyhttpClient.post(UrlConfig.MODIFY_DEAL_PASSWORD, params, new AsyncHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, byte[] arg2,
				...
				ToastUtil.show(DealPasswdActivity.this, getResources().getString(R.string.default_error));
...
//						PreferencesUtils.putValueToSPMap(RealNameActivity.this, PreferencesUtils.Keys.ID_CARD,id_no);
						PreferencesUtils.putBooleanToSPMap(DealPasswdActivity.this, PreferencesUtils.Keys.HAS_DEAL_PASSWD, true);
						ToastUtil.show(getApplication(), getResources().getString(R.string.change_deal_passwd_success));
						finish();
					}else{
